#!/usr/bin/env python3
"""Generate a t-SNE figure for the current 3-class GRU experiment."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Plot t-SNE embeddings for dataset_window")
    parser.add_argument("--data_dir", default="../dataset_window")
    parser.add_argument("--model_path", default="checkpoints_gru/window_gru_best.pt")
    parser.add_argument("--output_dir", default="experiments_window/visualization")
...
def main() -> None:
    ...
    figure_path = os.path.join(args.output_dir, "tsne_window_gru.png")
    data_path = os.path.join(args.output_dir, "tsne_window_gru.npz")
