...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output_dir", default="experiments_window/compression/pruning")
...
def main() -> None:
    ...
    output_checkpoint = os.path.join(
        args.output_dir,
        f"window_gru_pruned_{int(args.amount * 100):02d}.pt",
    )
    ...
    output_json = os.path.join(
        args.output_dir,
        f"window_gru_pruned_{int(args.amount * 100):02d}_summary.json",
    )
