...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--checkpoint", default="checkpoints_gru/window_gru_best.pt")
    parser.add_argument("--output_dir", default="experiments_window/compression/quantization")
...
def main() -> None:
    ...
    output_checkpoint = os.path.join(args.output_dir, "window_gru_dynamic_int8.pt")
    torch.save(
        {
    ...
    output_json = os.path.join(args.output_dir, "window_gru_dynamic_int8_summary.json")
